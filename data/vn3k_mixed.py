...
class VN3K_MIXED(BaseDataset):
    ...
    def __init__(self, root="", verbose=True, seed=42):
        super(VN3K_MIXED, self).__init__()
        ...
        if verbose:
            self.logger.info("=> VN3K_MIXED Images and Captions are loaded")
    ...
    def _process_anno(self, annos: List[dict], training=False):
        ...
        if training:
            ...
            for anno in annos:
                ...
                captions = anno["en_captions"] + anno["captions"]  # caption list
            ...
            for anno in annos:
                ...
                caption_list = anno["en_captions"] + anno["captions"]  # caption list
